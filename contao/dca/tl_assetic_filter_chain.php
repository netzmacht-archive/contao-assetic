...
(
	...
	(
		...
		(
			...
			'format'         => '[%s] %s',
			'label_callback' => array('Bit3\Contao\Assetic\DataContainer\AsseticFilterChain', 'listChain'),
		),
	...
	(
		...
		(
			...
			'exclude'          => true,
			'options_callback' => array('Bit3\Contao\Assetic\DataContainer\AsseticFilterChain', 'getFilterOptions'),
